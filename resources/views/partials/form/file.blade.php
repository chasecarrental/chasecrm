<div class="form-group @error($name ?? 'default_name') text-danger @enderror">
    ...
    <div class="custom-file">
        ...
        <label class="custom-file-label" for="customFile">{{ ucfirst(__('laravel-crm::lang.choose_file')) }}</label>
