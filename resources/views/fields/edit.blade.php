...
@section('content')
    ...
    <form method="POST" action="{{ url(route('laravel-crm.fields.update', $field)) }}">
        @csrf
        @method('PUT')
        <div class="card">
            ...
            <div class="card-body">
                <h3 class="mb-3"> {{ ucfirst(trans('laravel-crm::lang.edit_field')) }} <span class="float-right"><a type="button" class="btn btn-outline-secondary btn-sm" href="{{ url(route('laravel-crm.fields.index')) }}"><span class="fa fa-angle-double-left"></span> {{ ucfirst(trans('laravel-crm::lang.back_to_fields')) }}</a></span></h3>
