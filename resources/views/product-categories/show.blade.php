    ...
    <div class="card">
        ...
        <div class="card-body">
            <h3 class="mb-3"> {{ $productCategory->name }} <span class="float-right">
                <a type="button" class="btn btn-outline-secondary btn-sm" href="#" onclick="loadContent('{{ url(route('laravel-crm.product-categories.index')) }}')"><span class="fa fa-angle-double-left"></span> {{ ucfirst(__('laravel-crm::lang.back_to_product_categories')) }}</a> | 
                @can('edit crm product categories')
                <a href="#" onclick="loadContent('{{ url(route('laravel-crm.product-categories.edit', $productCategory)) }}')" type="button" class="btn btn-outline-secondary btn-sm"><span class="fa fa-edit" aria-hidden="true"></span></a>
                @endcan
