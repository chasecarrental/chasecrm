<form method="POST" action="{{ url(route('laravel-crm.users.sendinvite')) }}" onsubmit="submitFormCrm(event, this, '{{ url(route('laravel-crm.users.sendinvite') }}', '{{ __('Invite sent successfully!') }}', '{{ url(route('laravel-crm.users.index')) }}')">
    @csrf
    @component('laravel-crm::components.card')
        ...
        @component('laravel-crm::components.card-footer')
            ...
            <button type="submit" class="btn btn-primary">
                {{ ucwords(__('laravel-crm::lang.send_invite')) }}
            </button>
        @endcomponent
